...
def minv3(m):
    ...
    w = [[(m[1][1] * m[2][2] - m[1][2] * m[2][1]) / det, (m[0][2] * m[2][1] - m[0][1] * m[2][2]) / det, (m[0][1] * m[1][2] - m[0][2] * m[1][1]) / det],
         [(m[1][2] * m[2][0] - m[1][0] * m[2][2]) / det, (m[0][0] * m[2][2] - m[0]
                                                          [2] * m[2][0]) / det, (m[0][2] * m[1][0] - m[0][0] * m[1][2]) / det],
...
parser.add_option("-v", "--verbose", dest="verbose",
                  help="Print CIF to stdout", action="store_true")
parser.add_option("-o", "--output", dest="output",
                  help="Save CIF to named file", metavar="FILE")
parser.add_option("-e", "--elements", dest="elements",
                  help="""Supply elements if no POTCAR is present. Example: --elements="Fe,Co,Ni" """, metavar="list of elements")
    ...
    if filetype(input_file) == "POSCAR":
        ...
        if options.elements:
            ...
            if vasp5:
                ...
                potcar_lines = commands.getoutput(
        ...
        for line in titellines:
            ...
            atoms.append(words[3].split("_")[0])
        # How many of each?
        natoms = [int(s) for s in commands.getoutput(
            "grep 'ions per type =' " + filename).split()[4:]]
        ...
        for line in input_file:
            ...
            if vecline == 4:
                ...
                a, b, c = latticevectors[
                    0], latticevectors[1], latticevectors[2]
            ...
            if 0 <= posline < sum(natoms):
                ...
                cell.sites[posline] = (cell.sites[posline][
                                       0], c[0], c[1], c[2])
