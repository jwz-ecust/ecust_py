...
new_book_html = soup.find_all(
    'ul', class_='list-col list-col5 list-express slide-item')

book_info_list = []

for sub_html in new_book_html:
    for tag in sub_html.find_all('li'):
        ...
        abstract = info_html.find(
            class_='abstract').string.strip().encode('utf-8')
